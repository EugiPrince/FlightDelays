...
public class FXMLController {
    ...
    void doAnalizzaAeroporti(ActionEvent event) {
    	...
    	this.txtResult.appendText("N Vertici: "+this.model.vertexNumber()+"\n");
    	this.txtResult.appendText("N Archi: "+this.model.edgeNumber());
    ...
    void doTestConnessione(ActionEvent event) {
    	...
    	if(a1==null || a2==null) {
    		this.txtResult.appendText("Seleziona gli aeroporti.");
    		return;
    	}
