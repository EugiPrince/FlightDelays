...
public class ExtFlightDelaysDAO {
	...
	/**
	 * Per ogni aereoporto mi dice quante compagnie ci passano, cosi' da capire se rispettano il vincolo o meno.
	 * Nel codice SQL abbiamo messo la OR (||) perche' usiamo la tabella dei voli.. quindi l'aereoporto puo' essere
	 * sia quello di arrivo che quello di origine. Inoltre bisogna fare count distinct perche' la tabella riporta
	 * i voli, quindi bisogna distinguerli.
	 * @param a
	 * @return
	 */
